...
kr = KRIS.LINE()
#kr.login(qr=True)
kr.login(token="EorKB0EhHHvbfoG18s96.gEcIY3LppMxWq8W8etzNDG.Nz5E73Dz5Po8qhQZ7Ykm0EE7wxffD9gNa25Pib5UcqA=")
kr.loginResult()

kr1 = KRIS.LINE()
#kr1.login(qr=True)
kr1.login(token="Eodoqj5hcciybb9me1q7.IazHjpKWOLwLTdZ5BvpLfW.3Fy6oLwyPfJzjuW+vPhc4xXBmylS0Fz07vwQ5biEDXI=")
kr1.loginResult()

kr2 = KRIS.LINE()
#kr2.login(qr=True)
kr2.login(token="EoUgdS6TFiNxW27FJ4b4.QGeI7ZvV/bpuA+IoVzmYba.OqBUHspX2cVAv6ASLUgr/5HPGKqHE/Vrh4WkgPO7ZsU=")
kr2.loginResult()

kr3 = KRIS.LINE()
#kr3.login(qr=True)
kr3.login(token="EoP5OyeFJWKwJr4MpAk0.p+qv7brEDBYpPMvRpKP5ma.0x5a/KIwmesv26lbiM7ZNWuNn1RVZIa3KNM+XiqF1RI=")
kr3.loginResult()

kr4 = KRIS.LINE()
#kr4.login(qr=True)
kr4.login(token="EoryPhSd9x1XEHVd7la4.AHAwpLn74EhKG39W6vHGXa.zC0Xgw0ojON3w9dVajMOXhosie9A2jMIZ/pCP35tybc=")
kr4.loginResult()


kr5 = KRIS.LINE()
#kr5.login(qr=True)
kr5.login(token="EoTiTADnLhLLAq0u5uP3.o5gc3OmqTferANd434g6GW.YmvmWqCSGUYq0hu3KPQghLKQstl7hbGPEHAN6+Xc52o=")
kr5.loginResult()
...
induk=[mid]
owner=["u19e0a2cb794f3e65f043cc3c11366776"]
admin=["u19e0a2cb794f3e65f043cc3c11366776",mid,mid1,mid2,mid3,mid4,mid5]
        ...
        if op.type == 26:#25
            ...
            if msg.text is None:
                ...
                if msg.from_ in owner:
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': "u19e0a2cb794f3e65f043cc3c11366776',"}
                    kr.sendMessage(msg)
                    kr.sendMessage(msg)
